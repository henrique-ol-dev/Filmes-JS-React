...
class Filmes extends Component {
    ...
    constructor() {
        ...
        //string user {get; set} = 'https://5f83ada76b97440016f4e80f.mockapi.io/api/filmes'
        //object [] filmes {get; set} 
        this.state = {
            url: 'https://5f83ada76b97440016f4e80f.mockapi.io/api/filmes',
            filmes: [],
            id : '',
            nome : '',
            categoria : '',
    ...
    render() {
        return (
            <div>
                <Menu />
                <Jumbotron titulo='Filmes' descricao='Gerencia os seus filmes' />
